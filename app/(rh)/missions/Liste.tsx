                    ...
                    <div>
                        <form className='form border-t flex flex-col gap-5 mt-4' onSubmit={handleSubmit}>
                            <div className='mt-4'>
                                ...
                                <input type="text" id='objet' placeholder='Objet de la mission' className='outline-none rounded-2xl'/>
                            </div>

                            <div className=''>
                                <label htmlFor="desc">Description de la mission</label>
                                <input type="text" id='desc' placeholder='Description de la mission' className='outline-none rounded-2xl'/>
                            </div>

                            <div className=''>
                                <label htmlFor="continent">Continent de la mission</label>
                                <input type="text" id='continent' placeholder='Objet de la mission' className='outline-none rounded-2xl'/>
                            </div>

                            <div className=''>
                                <label htmlFor="pays">Pays de la mission</label>
                                <input type="text" id='pays' placeholder='Pays de la mission' className='outline-none rounded-2xl'/>
                            </div>

                            <div className=''>
                                <label htmlFor="ville">Ville de la mission</label>
                                <input type="text" id='ville' placeholder='Ville de la mission' className='outline-none rounded-2xl'/>
                            </div>
