...
const columns = [
    {
        name: "Num ODM",
        selector: (row:any) => row.Id_ordre_mission,
        sortable: true,
        cell: (row:any)=>(
    ...
    },
    {
        ...
        selector: (row:any) => row.Nom_prenom_participant,
        sortable: true,
        cell: (row:any)=>(
    ...
    {
        name: "Départ",
        selector: (row:any) => row.Date_depart,
        cell:(row:any)=>(
    ...
    {
        name: "Retour",
        selector: (row:any) => row.Date_retour,
        cell:(row:any)=>(
    ...
    {
        name: "Statut",
        selector: (row:any) => row.Statut_ODM,
        cell: (row:any) => (
...
const page = () => {
    ...
    const [missionById, setMissionById] = useState<any>([])

    const getMissionById = () => {
        try {
            axiosInstance.get(`mission/getbyid/${id}`)
                .then(res => {
    ...
    const [odmByIdMission, setOdmByIdMission] = useState([])
    const getOdmByIdMission = () => {
        try {
    ...
    return (
        <ProtectedRoute>
            <div className='p-2'>
                <Jumbotron icon='/assets/images/add-files.png' title='Liste des ODM pour une mission' />

                <div className='bg-white rounded-lg p-6 mt-2 shadow-xl'>
                    <Image src={'/assets/images/logo-file-odm.png'} width={500} height={250} alt='' />
                        ...
                        <div>
                            <div className='text-gray-800 mt-5 shadow-2xl p-2'>
                                <span>
                                    ...
                                    {missionById[0].Objet_mission}
                                </span>

                                <div className='flex flex-col gap-4 md:flex-row p-4 mt-3'>
                                    <div className='w-full lg:w-1/3'>
                                        <p className='flex'>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 text-gray-400">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
                                            </svg>
                                            &nbsp;<span className='text-[#B2241B]'>Continent de la mission</span>
                                        </p>
                                    ...
                                    <div className='w-full lg:w-1/3'>
                                        <p className=' flex'>
                                            ...
                                            &nbsp;<span className='text-[#B2241B]'>Pays de la mission</span></p>
                                    ...
                                    <div className='w-full lg:w-1/3'>
                                        <p className='flex'>
                                            ...
                                            &nbsp;<span className='text-[#B2241B]'>Ville de la mission</span>
                                        </p>
                            ...
                            <p className='bg-gray-300 p-2 mt-4 mb-4 uppercase text-blue-800 font-bold'>Liste des odm pour cette mission</p>
