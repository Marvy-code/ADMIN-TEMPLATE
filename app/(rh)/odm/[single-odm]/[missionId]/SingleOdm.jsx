            ...
            <div className='flex flex-col gap-4 md:flex-row p-2 mt-5'>
                ...
                <div className='w-full lg:w-1.5/3 bg-white'>
                    <div className='rounded-2xl shadow-2xl'>
                        ...
                        <div className='p-4 border-t md:mt-5 mt-8'>
                            <p className='flex'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 text-gray-400">
                                 ...
                                 Objet de la mission:</p>
                            <p><span className='text-red-500'>Formation sur l'IA et la 5G</span></p>
                        </div>
                        ...
                        <div className='p-4 border-t md:mt-5 mt-8'>
                            <p className='font-bold'>2 ODM ont été retrouvés pour cette mission <span className='float-end text-blue-700 flex'><Link href={'/missions/2/text'}>Consulter les ODM</Link></span></p>
                        </div>
